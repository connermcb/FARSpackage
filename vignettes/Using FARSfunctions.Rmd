...
The principle function in `FARSfunctions` is `fars_map_state`, which takes produces a simple geographic plot of the given state with all traffic fatalities for the given year plotted as points.  
